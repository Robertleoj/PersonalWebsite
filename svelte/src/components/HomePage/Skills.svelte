<script lang="ts">
    ...
    import Browser from "@icons/browser.svelte";
    import Science from "@icons/science.svelte";
...
<div class="
    grid lg:grid-cols-3 md:grid-cols-1 md:w-full md:mx-10 sm:mx-3 -mb-20 pb-0
