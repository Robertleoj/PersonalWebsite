...
<div class="flex justify-center w-screen bg-gray-100 pb-56">
    <div
        class="
            flex flex-col items-center justify-evenly md:px-20 px-5
            max-w-7xl
        "
    >
        <h3 class="text-3xl font-bold leading-relaxed text-center py-10">
            Nice to meet you.
        </h3>

        <p 
            class="text-2xl leading-relaxed text-center"
        >
